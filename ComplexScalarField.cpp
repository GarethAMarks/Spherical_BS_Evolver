...
// Energy density rho = n^a n^b T_ab (stub)
...
// Momentum density j_z = -n^a gamma^b{}_z T_ab (stub)
...
// Stress S_zz = gamma^a{}_z gamma^b{}_z T_ab (stub)
...
// Stress S_ww (angular trace component) (stub)
